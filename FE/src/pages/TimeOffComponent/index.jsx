...
export default function TimeOffComponent() {
    ...
    const header = ["ID", "Ngày bắt đầu", "Ngày kết thúc", "Số ngày nghỉ", "Trạng thái", "ID nhân sự", "Chức năng"];
    const row = filteredOvertimes.map((timeOff) => ({
        data: [timeOff.timeOffId.toString(), timeOff.dateStart, timeOff.dateEnd, timeOff.dayNumber.toString(), timeOff.status ? "Có hiệu lực" : "Hết hiệu lực", timeOff.employeeId.toString()],
